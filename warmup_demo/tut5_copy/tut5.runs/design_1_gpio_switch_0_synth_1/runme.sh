...
HD_PWD='C:/Users/srini/tut5_copy/tut5.runs/design_1_gpio_switch_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_gpio_switch_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_gpio_switch_0.tcl
